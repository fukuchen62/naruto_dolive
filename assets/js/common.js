...
window.addEventListener("scroll", function () {
    ...
    // スクロール値が1800以上 スクロール値が1800で余った余りが10以下であるか確認(例 1800 3610 5410など) carDisplayedがfalseの時(車が表示されていないとき)
    if (scrollTop >= 1800 && Math.floor(scrollTop % 1800) <= 10 && !carDisplayed) {
