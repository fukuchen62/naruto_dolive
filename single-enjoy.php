                            ...
                            <div class="facility_tag">
                                ...
                                foreach ($enjoy_types as $enjoy_type) : ?>
                                    ...
                                    <div class="facility_tag_btn">
                                        <a class="facility_tag_link" href="<?php echo home_url(); ?>?s=<?php echo $enjoy_type; ?>">
                                            <span class="facility_tag_name style=" border: 1px solid black;"><?php echo $enjoy_type; ?></span>
                                        </a>
                                    </div>
                                <?php endforeach ?>
                            </div><!-- facility_tag -->
